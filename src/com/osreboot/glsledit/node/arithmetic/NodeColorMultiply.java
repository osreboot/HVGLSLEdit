...
public class NodeColorMultiply extends Node{

	private PinColor input1, input2, output;

	public NodeColorMultiply(float x, float y){
		super("color multiply", x, y, Node.WIDTH_NORMAL, Node.COLOR_MATH_OPERATOR);
